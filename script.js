...
function showJoke() {
    ...
    const jokeTag = document.createElement('p');
    jokeTag.textContent = randomJokeText;

    clearAll();
    container.appendChild(jokeTag);
}
...
function showQuote() {
    ...
    quoteTag.textContent = randomQuote.quote;
    authorTag.textContent = randomQuote.author;

    clearAll();
    container.appendChild(quoteTag);
...
function showRiddle() {
    ...
    answerTag.textContent = `The answer is: ${answer}`;
    answerTag.setAttribute('id', 'riddle-answer');
    ...
    container.appendChild(answerTag);
...
function revealAnswers() {
    ...
    if (riddle && answer.hidden) {
        ...
        alert('There is already a riddle and answer')
    } else {
